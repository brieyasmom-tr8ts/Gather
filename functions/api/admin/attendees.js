  ...
  try {
    ...
    if (search) {
      ...
      result = await env.DB.prepare(
        `SELECT id, ticket_id, first_name, last_name, email, phone, giver_army, giver_army_tenure, photo_consent, is_waitlist, checked_in, checked_in_at, cancelled, cancelled_at, created_at
         FROM attendees
