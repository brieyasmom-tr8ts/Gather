      ...
      <section id="details" className="py-20 md:py-24 px-6 bg-gray-50">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-5">
            ...
            <DetailCard
              title="Become a VIP"
              line1="Join the Giver Army today"
              line2="Get exclusive access to the VIP Cocktail Hour and be part of the generosity movement."
              icon={<IconStar />}
              link="https://www.giverarmy.com"
              linkText="Join Giver Army &rarr;"
            />
          </div>
        </div>
      </section>
